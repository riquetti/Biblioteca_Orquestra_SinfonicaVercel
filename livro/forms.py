...
class CadastroLivro(forms.ModelForm):
    class Meta:
        model = Livros
        fields = ['categoria','compositor', 'arranjador', 'obra', 'classificacao', 'conteudo', 'edicao', 'edicao', 'observacao', 'data_cadastro', 'emprestado', 'localizacao', 'categoria', 'formato', 'usuario']
